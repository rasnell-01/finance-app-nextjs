...
begin
	...
	currentStart := case
		...
		when range_arg = 'last90days' then currentEnd - interval '90 days'
        when range_arg = 'last180days' then currentEnd - interval '180 days'
        when range_arg = 'last365days' then currentEnd - interval '365 days'
	    when range_arg = 'all_time' then '1775-01-01'
